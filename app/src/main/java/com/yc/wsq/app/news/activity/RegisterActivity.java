...
public class RegisterActivity extends BaseActivity<UserRegisterView, UserPresenter<UserRegisterView>> implements UserRegisterView{
    ...
    protected void initView() {
        ...
        tv_title.setText(getResources().getText(R.string.str_user_register_text));
    }
    ...
    public void onClick(View view){
        ...
        switch (view.getId()){
            ...
            case R.id.tv_get_validate:
                ...
                param.put(ResponseKey.getInstace().scene, "1");
                try {
            ...
            case R.id.tv_register:
                param.put(ResponseKey.getInstace().username, et_mobile.getText().toString().trim());
