 ...
 * 徒弟列表
 */
public class ApprenticeActivity extends BaseActivity<UserView, UserPresenter<UserView>> implements UserView, RadioGroup.OnCheckedChangeListener {
    ...
    private void  onInitRecyclerView(){
        ...
        mAdapter = new ApprenticeAdapter(this, mData, listener);
