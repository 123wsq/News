...
public class InviteCodeActivity extends BaseActivity<UserView, UserPresenter<UserView>> implements UserView{
    ...
    public void onResponseData(Map<String, Object> result) {
        ...
        SharedTools.getInstance(this).onPutData(ResponseKey.getInstace().first_leader, et_invite_code.getText().toString());
