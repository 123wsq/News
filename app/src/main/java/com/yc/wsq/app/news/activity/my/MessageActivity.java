 ...
 * 历史记录
 */
public class MessageActivity extends BaseActivity<UserView, UserPresenter<UserView>> implements UserView{
    ...
    protected void initView() {
        tv_title.setText(getResources().getString(R.string.str_message_text));
    }
