...
public class ValidateAccountActivity extends BaseActivity<UserRegisterView, UserPresenter<UserRegisterView>> implements UserRegisterView{
    ...
    protected void initView() {
        ...
        mobile = SharedTools.getInstance(this).onGetString(ResponseKey.getInstace().mobile);
