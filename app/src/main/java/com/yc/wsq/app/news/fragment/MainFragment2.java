...
public class MainFragment2 extends BaseFragment implements ViewPager.OnPageChangeListener {

    public static final String TAG = MainFragment2.class.getName();
    ...
    protected int getLayoutId() {
        return R.layout.layout_fragment_main2;
    }
