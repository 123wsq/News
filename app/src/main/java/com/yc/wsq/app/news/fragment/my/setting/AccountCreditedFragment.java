 ...
 * 收款账户设置页面
 */
public class AccountCreditedFragment extends BaseFragment<UserView, UserPresenter<UserView>> implements UserView{

    public static  final String TAG = AccountCreditedFragment.class.getName();
    ...
    protected void initView() {
        ...
        et_account.setText(SharedTools.getInstance(getActivity()).onGetString(ResponseKey.getInstace().alipay_bank_card));
        et_realname.setText(SharedTools.getInstance(getActivity()).onGetString(ResponseKey.getInstace().alipay_realname));
    }
    ...
    public void onResponseData(Map<String, Object> result) {
        ...
        SharedTools.getInstance(getActivity()).onPutData(ResponseKey.getInstace().alipay_bank_card, et_account.getText().toString().trim());
        SharedTools.getInstance(getActivity()).onPutData(ResponseKey.getInstace().alipay_realname, et_realname.getText().toString().trim());
