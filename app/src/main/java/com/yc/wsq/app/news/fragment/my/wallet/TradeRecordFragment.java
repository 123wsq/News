 ...
 * 交易记录
 */
public class TradeRecordFragment extends BaseFragment<UserView, UserPresenter<UserView>> implements UserView{

    public static final String TAG = TradeRecordFragment.class.getName();
