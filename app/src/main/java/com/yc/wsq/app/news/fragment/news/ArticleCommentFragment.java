...
public class ArticleCommentFragment extends BaseFragment<NewsView, NewsPresenter<NewsView>> implements NewsView{

    public static final String TAG = ArticleCommentFragment.class.getName();
    ...
    private void  onInitRecyclerView(){
        ...
        mAdapter = new ArtivleCommentAdapter(getActivity(), mData, listener);
