...
/**
     ...
     * @param callBack
     */
    public static void okHttpUploadListMapFile(String url, Map<String, String> paramsMap, List<Map<String, Object>> fileListMap,  CallBackUtil callBack) {
        okHttpUploadMapFile(url, paramsMap, fileListMap, callBack);
    }

    public static void okHttpUploadMapFile(String url, Map<String, String> paramsMap, List<Map<String, Object>> fileListMap, CallBackUtil callBack) {
        new RequestUtil(METHOD_POST, url, paramsMap,fileListMap, callBack);
    }

    public static void okHttpFilePost(String url, Map<String, String> paramsMap, List<Map<String, Object>> fileListMap, CallBackUtil callBack) {

        new RequestUtil(METHOD_POST, url, paramsMap, fileListMap, callBack).execute();
    }
    public static void okHttpFileGet(String url, Map<String, String> paramsMap, List<Map<String, Object>> fileListMap, CallBackUtil callBack) {

        new RequestUtil(METHOD_GET, url, paramsMap, fileListMap, callBack).execute();
    }
